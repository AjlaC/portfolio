  ...
  <div id="app">
    ...
    <div class="row m-3">
      <div class="col-12 col-sm-9">
        <b-img src="~assets/shareit-header.png" thumbnail fluid />
        <h4>About</h4>
    ...
    <div class="row m-3">
      <div class="col-12 col-sm-9">
        ...
        <b-img src="~assets/share-it/sketches-navigation.png" thumbnail fluid />
      </div>
    </div>
    ...
    <div class="row m-3">
      <div class="col-12 col-sm-9">
        ...
        <div class="row">
          <div class="col">
            <b-img src="~assets/share-it/ShareIT-posting.gif" thumbnail fluid />
          </div>
          <div class="col">
            <b-img src="~assets/share-it/ShareIT-renting.gif" thumbnail fluid />
          </div>
        </div>
      </div>
    </div>
